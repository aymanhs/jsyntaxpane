...
//    @Override
     ...
     * 
     * @param kit the syntax to configure.
     * @param config Map of key value pairs.  Should be {@code Map<String, String> or}
     * or {@link Properties} object.
     */
    public static void setConfig(Class<? extends DefaultSyntaxKit> kit, Map config) {
        getConfig(kit).putAll(config);
    }
     ...
     * @param value
     */
    public static void setProperty(Class<? extends DefaultSyntaxKit> kit,
            String key, String value) {
        getConfig(kit).put(key, value);
    }
     ...
     */
    public static String getProperty(Class<? extends DefaultSyntaxKit> kit,
            String key) {
        return getConfig(kit).getString(key);
    }
    ...
    /**
     * Get a STring property of this EditorKit.
     * @param string
     * @return
     */
